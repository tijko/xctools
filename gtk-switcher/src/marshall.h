...
/* VOID:STRING,STRING,STRING,INT (marshall.list:3) */
extern void g_cclosure_user_marshal_VOID__STRING_STRING_STRING_INT (GClosure     *closure,
                                                                    GValue       *return_value,
                                                                    guint         n_param_values,
                                                                    const GValue *param_values,
                                                                    gpointer      invocation_hint,
                                                                    gpointer      marshal_data);
void
g_cclosure_user_marshal_VOID__STRING_STRING_STRING_INT (GClosure     *closure,
                                                        GValue       *return_value G_GNUC_UNUSED,
                                                        guint         n_param_values,
                                                        const GValue *param_values,
                                                        gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:STRING,OBJECT (marshall.list:4) */
...
/* VOID:POINTER,POINTER (marshall.list:5) */
